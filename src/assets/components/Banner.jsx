...
const Banner = () => {
  return (
    <div className="w-11/12 mx-auto bg-purple-600 border-none  rounded-b-lg text-white relative mb-[40vh]">
        ...
        <div className="flex justify-center py-5 pb-[35vh]"><button className="text-purple-00 px-3 py-2 border-none rounded-full bg-white text-black font-bold">Shop Now</button></div>
