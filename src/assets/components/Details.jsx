...
const Details = () => {
  ...
  return (
    ...
    <div className="w-11/12 mx-auto bg-purple-600 border-none  rounded-b-lg text-white relative mb-[45vh]">
        ...
        <div className="w-6/12 absolute top-[55%] left-[25%] rounded-lg border-2 bg-white grid grid-cols-2 md:grid-cols-3 items-center p-5">
